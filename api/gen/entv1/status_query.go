...
func (sgb *StatusGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entv1: StatusGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StatusGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{status.Label}
	default:
		err = fmt.Errorf("entv1: StatusGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *StatusGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entv1: StatusGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StatusGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{status.Label}
	default:
		err = fmt.Errorf("entv1: StatusGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *StatusGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entv1: StatusGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StatusGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{status.Label}
	default:
		err = fmt.Errorf("entv1: StatusGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *StatusGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entv1: StatusGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StatusGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{status.Label}
	default:
		err = fmt.Errorf("entv1: StatusGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StatusSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entv1: StatusSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StatusSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{status.Label}
	default:
		err = fmt.Errorf("entv1: StatusSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StatusSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entv1: StatusSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StatusSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{status.Label}
	default:
		err = fmt.Errorf("entv1: StatusSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StatusSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entv1: StatusSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StatusSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{status.Label}
	default:
		err = fmt.Errorf("entv1: StatusSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StatusSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entv1: StatusSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StatusSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{status.Label}
	default:
		err = fmt.Errorf("entv1: StatusSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
