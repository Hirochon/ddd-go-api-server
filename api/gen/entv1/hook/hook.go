...
type StatusFunc func(context.Context, *entv1.StatusMutation) (entv1.Value, error)

// Mutate calls f(ctx, m).
func (f StatusFunc) Mutate(ctx context.Context, m entv1.Mutation) (entv1.Value, error) {
	mv, ok := m.(*entv1.StatusMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *entv1.StatusMutation", m)
	}
	return f(ctx, mv)
}
